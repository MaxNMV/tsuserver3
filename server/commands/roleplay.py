...
def ooc_cmd_notecard_clear(client, arg):
    ...
    try:
        ...
        client.area.broadcast_ooc('{} erased their note card.'.format(client.char_name))
...
def ooc_cmd_rolla(client, arg):
    ...
    database.log_room('rolla', client, client.area,message=f'{roll} out of {max_roll}: {ability}')
...
def ooc_cmd_coinflip(client, arg):
    ...
    client.area.broadcast_ooc('{} flipped a coin and got {}.'.format(client.char_name, flip))
...
def ooc_cmd_8ball(client, arg):
    ...
    client.area.broadcast_ooc('{} asked a question: {} and the answer is: {}.'.format(client.char_name, arg, rolla(ability_dice)[2]))
